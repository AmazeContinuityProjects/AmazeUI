...
export default function NavigationTabs({
  ...
  handleLogOutRequest,
  handleReloadRequest,
  currSemesterID: _currSemesterID,
  setCurrSemesterID,
  handleLogin,
  setIsReloading,
  username,
  ...
  const [, setExpandedGroup] = useState<string>("study")
  ...
  const persistSidebarState = useCallback(
    (nextCollapsed: boolean) => {
      ...
      localStorage.setItem(
        "settings",
        JSON.stringify({ ...settings, isSidebarCollapsed: nextCollapsed })
      )
    },
  ...
  const sidebarActiveStyles =
    "bg-sidebar-accent border border-sidebar-border text-info font-semibold"
  ...
  const handleNavKeyDown = useCallback((event: KeyboardEvent<HTMLElement>, action: () => void) => {
    ...
    if (event.key === "ArrowDown" || event.key === "ArrowUp") {
      ...
      const buttons = Array.from(
        document.querySelectorAll<HTMLElement>("[data-sidebar-nav='true']")
      )
    ...
    const primaryGroups = [
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: GraduationCap,
            type: "panel",
            action: () => setMobilePanel("academics"),
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            icon: CarTaxiFront,
            type: "link",
            action: () => selectTab("cabshare"),
          },
          {
            label: "Payments",
            icon: CreditCard,
            type: "link",
            action: () => selectTab("payments"),
          },
    ...
    return (
      <>
        ...
        >
            ...
            filteredSearchItems.length === 0 ? (
              <div className="py-12 text-center">
                <p className="text-sm font-semibold text-gray-400 dark:text-gray-500">
                  No modules found matching "{librarySearchQuery}"
                </p>
              </div>
            ) : (
              <div className="space-y-2">
                <h3 className="px-1 text-[11px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">
                  Search Results
                </h3>
                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          item.action()
                          if (!isPanelTrigger) setIsAppLibraryOpen(false)
                        }}
                      ...
                      >
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <span className="truncate text-xs font-bold leading-tight text-gray-700 dark:text-gray-300">
                            {item.label}
                          </span>
                        </div>
                        {isPanelTrigger && (
          ...
          >
            <h4 className="px-0.5 text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">
              Interface Theme
            </h4>
            ...
            <h4 className="px-0.5 text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 mt-3">
              API Server
            </h4>
            <div className="flex w-full gap-1 rounded-xl border border-gray-200/20 bg-gray-200/50 p-1 dark:border-gray-800/50 dark:bg-gray-900/50">
              <button
          ...
          >
            ...
            {isOpen && (
              <div className="flex items-center gap-0.5">
                ...
                >
                  <RefreshCcw
                    className={`h-4 w-4 transition-transform ${isSpinning ? "animate-spin" : "group-hover:rotate-180 duration-500"}`}
                  />
                </button>
                <button
              ...
              >
                ...
                <div className="mt-3 rounded-lg border border-sidebar-border bg-sidebar-accent/50 p-2.5 text-[11px] space-y-1.5 shadow-2xs">
                  <div className="flex items-center justify-between">
                    <div className="font-semibold text-sidebar-foreground/75 tracking-wide text-[10px] uppercase">
                      Current Semester
                    </div>
                    <div className="relative flex items-center">
                      <OptionPicker
                  ...
                  <div className="space-y-1">
                    {shouldDisplayGpa && (
                      ...
                      >
                        ...
                        <span
                          className={`font-semibold text-sidebar-foreground transition-all duration-300 ${settings.CGPAHidden ? "blur-[4.5px] select-none" : ""}`}
                        >
                          {marksData?.cgpa?.cgpa || "-"}
                        </span>
                      </button>
                        ...
                        setSettings((prev: any) => {
                          const next = {
                            ...
                            attendancePercentageOrString:
                              prev.attendancePercentageOrString === "percentage"
                                ? "str"
                                : "percentage",
                          }
                          localStorage.setItem("settings", JSON.stringify(next))
                    ...
                    >
                      ...
                      <span
                        className={`font-semibold ${attendancePercentage?.percentage < 75 ? "text-rose-400" : "text-emerald-400"}`}
                      >
                        {attendanceValue}
                      </span>
                    </button>
                ...
                >
                  ...
                  <span className="flex-1 truncate transition-colors group-hover:text-sidebar-foreground/">
                    Search anything...
                  </span>
              ...
              {groups.map((group) => {
                ...
                return (
                  <div key={group.id} className="relative flex justify-center group/rail">
                    ...
                    >
                      <GroupIcon
                        className={`h-5 w-5 transition-transform duration-300 ${isActive ? "scale-110 text-info" : ""}`}
                      />
                    </button>
                  </div>
                )
            ...
            >
              {activeRailGroup === "account" ? (
                  ...
                  <div className="space-y-1">
                    ...
                    {groups
                      ...
                      ?.items.map((item) => (
                        ...
                        >
                          <item.icon
                            className={`h-4 w-4 shrink-0 ${item.isActive ? "text-info" : "text-sidebar-foreground/"}`}
                          />
                    ...
                    <div className="space-y-0.5">
                      ...
                      >
                        <div className="pl-6 space-y-1 py-1">
                          ...
                          >
                            <span
                              className={`flex h-3 w-3 items-center justify-center rounded-full border transition-colors ${theme === "light" ? "border-info text-info bg-info-surface" : "border-sidebar-border"}`}
                            >
                              {theme === "light" && (
                                <span className="h-1 w-1 rounded-full bg-info" />
                              )}
                            </span>
                            <span className={theme === "light" ? "text-info font-medium" : ""}>
                              Light
                            </span>
                          </button>
                          <button
                          ...
                          >
                            <span
                              className={`flex h-3 w-3 items-center justify-center rounded-full border transition-colors ${theme === "dark" ? "border-info text-info bg-info-surface" : "border-sidebar-border"}`}
                            >
                              {theme === "dark" && (
                                <span className="h-1 w-1 rounded-full bg-info" />
                              )}
                            </span>
                            <span className={theme === "dark" ? "text-info font-medium" : ""}>
                              Dark
                            </span>
                          </button>
                        </div>
                ...
                <div>
                  ...
                  <div
                    className="space-y-0.5 overflow-y-auto max-h-[60vh]"
                  ...
                  >
                    {academicsItems.map((item, index) => {
                      ...
                      return (
                        <div key={item.id}>
                          {showDivider && <div className="my-1.5 border-t border-sidebar-border" />}
                          <button
                            onClick={() => {
                              item.onSelect()
                              setActiveRailGroup(null)
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {groups
                      .find((g) => g.id === activeRailGroup)
                      ?.items.map((item) => {
                        const activeStyles = railActiveStyles
                        const inactiveStyles =
                          "border-transparent text-sidebar-foreground/ hover:bg-sidebar-accent hover:text-sidebar-foreground hover:translate-x-1"
                        return (
                          <button
                            key={item.id}
                            onClick={() => {
                          ...
                          >
                            <item.icon
                              className={`h-4.5 w-4.5 shrink-0 transition-all duration-300 ${item.isActive ? "text-info scale-110" : "text-sidebar-foreground/ group-hover:text-sidebar-foreground"}`}
                            />
