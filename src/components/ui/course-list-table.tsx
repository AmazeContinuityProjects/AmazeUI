...
export function CourseListTable({
  ...
  renderTypeChips,
  getBatchBadgeClass = () =>
    "bg-gray-100/50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-700",
  title = "Course List",
  className,
  ...
  return (
    <div
      className={cn(
        "bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm flex flex-col",
        className
      )}
    >
        ...
        <table className="w-full text-left border-collapse min-w-[600px]">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
            {courses.map((c) => (
              <tr
                key={c.id}
                className="hover:bg-gray-100/10 dark:hover:bg-gray-900/10 transition-colors"
              >
                ...
                <td className="py-3 px-2">
                  <div className="flex flex-wrap gap-1">
                    {c.slots.map((s) => (
                      <span
                        key={s}
                        className="bg-gray-100/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 text-[10px] px-1.5 py-0.5 rounded-md"
                      >
                        {s}
                      </span>
                    ))}
                ...
                <td className="py-3 px-2 text-sm text-gray-900/80 dark:text-gray-100/80 max-w-xs">
                  {c.venue}
                </td>
                <td className="py-3 px-2 text-sm text-gray-900/80 dark:text-gray-100/80">
                  {c.credits}
